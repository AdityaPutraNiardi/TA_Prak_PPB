...
const Profil = () => {
  const handleIconPress = (socialMedia) => {
    ...
    switch (socialMedia) {
      case 'instagram':
        url = 'https://www.instagram.com/adit_niardi/';
        break;
      case 'linkedin':
        url = 'https://www.linkedin.com/in/adityaputraniardi/';
        break;
      case 'github':
        url = 'https://github.com/AdityaPutraNiardi';
        break;
      default:
        break;
    }
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require('../assets/fotoadit.jpg')}
        style={styles.profileImage}
      />

      <View style={styles.profileInfo}>
        <Text style={styles.name}>Aditya Putra Niardi</Text>  
        <Text style={styles.major}>21120121130063</Text>
